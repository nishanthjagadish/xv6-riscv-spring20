...
void find(const char* path, const char* next, const char* filename, int firstime) {
  int fd;
  struct dirent de;  // dirent.h - format of directory entries 
  struct stat st;    // sys/stat.h - data returned by the stat() function
